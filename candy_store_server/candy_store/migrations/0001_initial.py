...
import candy_store.services.product_service
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='Описание')),
                ('unit', models.CharField(choices=[('pieces', 'шт'), ('grams', 'гр')], default='pieces', max_length=20, verbose_name='Единица измерения')),
                ...
                ('image_path', models.ImageField(blank=True, null=True, upload_to=candy_store.services.product_service.get_image_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg'])], verbose_name='Изображение')),
